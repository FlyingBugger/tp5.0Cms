        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo Url('/index/Index/page/id/'.$vo['id']); ?>" target="_blank"><?php echo $vo['post_title']; ?></a></td>
                    <td><?php echo $vo['user_login']; ?></td>
                    <td><?php echo $vo['post_date']; ?></td>
                    <td><?php echo $vo['template']; ?></td>
                    <td>
                        <a href="<?php echo Url('editpage'); ?>?art=<?php echo $vo['id']; ?>" target="_blank"><?php echo lang('Edit'); ?></a>
                        &nbsp;|&nbsp;
...
<div class="hidden" id="shanchuyemian"><?php echo lang('Are you sure you want to delete the page?'); ?></div>
<div class="hidden" id="wufahuifu"><?php echo lang('Can not be restored after deletion!'); ?></div>
...
<script src="<?php echo $domain; ?>public/common/js/allpage.js"></script>
