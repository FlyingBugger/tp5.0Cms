...
<div class="row bg-info text-center">
    <h4><?php echo lang('Edit category'); ?></h4>
</div><br>
<div class="container-fluid" style="min-height: 800px;">
    <div class="row">
        <form method="post" action="">
            <h4><?php echo lang('With'); ?>&nbsp;<b><span class="text-danger">*</span></b>&nbsp;<?php echo lang('are required'); ?>&nbsp;<small>[<a href="<?php echo Url('/admin/Index/addclassify'); ?>"><?php echo lang('Add a new category'); ?></a>]</small></h4>
            <div class="form-group">
                <label><?php echo lang('Category name'); ?>：&nbsp;<b><span class="text-danger">*</span></b></label>
                <input type="text" value="<?php echo $data['term_name']; ?>" class="form-control" name="fenleim" placeholder="<?php echo lang('Category name'); ?>" required autofocus>
                <input type="hidden" name="cid" id="cid" value="<?php echo $data['id']; ?>">
            </div>
            <div class="form-group">
                <label><?php echo lang('Category parent'); ?>：&nbsp;<b><span class="text-danger">*</span></b></label>
                <select class="form-control" name="shangji" id="shangji">
                    ...
                    <option value="<?php echo $vo['id']; ?>"<?php if($data['parent_id'] == $vo['id']): ?> selected<?php endif; ?>><?php echo $vo['level']; if($vo['level'] != ''): ?>└&nbsp;<?php endif; ?><?php echo $vo['term_name']; ?></option>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
            <div class="form-group">
                <label><?php echo lang('Category description'); ?></label>
                <textarea class="form-control" rows="3" name="miaoshu"><?php echo $data['description']; ?></textarea>
            </div>
            <hr>
...
<script src="<?php echo $domain; ?>public/common/js/modifyclassify.js"></script>
