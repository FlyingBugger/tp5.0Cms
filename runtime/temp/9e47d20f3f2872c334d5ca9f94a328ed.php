...
<div class="row bg-info text-center">
    <h4><?php echo lang('All messages'); ?></h4>
</div><br>
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th><?php echo lang('Message title'); ?></th>
                    <th><?php echo lang('Message content'); ?></th>
                    <th><?php echo lang('Message time'); ?></th>
...
<div class="hidden" id="bukehuifu"><?php echo lang('Are you sure you want to delete the message? Can not be restored after deletion!'); ?></div>
...
<script src="<?php echo $domain; ?>public/common/js/messages.js"></script>
