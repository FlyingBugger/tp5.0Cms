    ...
    <div class="row">
        <div class="panel panel-default" style="display:none;">
            ...
            <div class="panel-body">
                <h4><?php echo lang('System name'); ?>：<?php echo \think\Config::get('version.name'); ?>&nbsp;<?php echo \think\Config::get('version.description'); ?></h4>
                <h4><?php echo lang('System version'); ?>：<?php echo \think\Config::get('version.number'); ?></h4>
                <h4><?php echo lang('The latest version'); ?>：<span id="latestversion"><span><small><?php echo lang('The latest version is being detected'); ?></small>&nbsp;<img src="<?php echo $domain; ?>public/common/images/zhixing.gif" width="16" height="16"></span></span></h4>
                <h4><?php echo lang('Official website'); ?>：<a id="catfishgw" href="http://www.<?php echo \think\Config::get('version.official'); ?>" target="_blank">www.<?php echo \think\Config::get('version.official'); ?></a></h4>
            </div>
        </div>
        <?php if(!(empty($zxwenzhang) || ($zxwenzhang instanceof \think\Collection && $zxwenzhang->isEmpty()))): ?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo lang('Latest articles'); ?>&nbsp;<small>[<a href="<?php echo Url('articles'); ?>"><?php echo lang('All articles'); ?></a>]</small></h3>
            </div>
            <div class="panel-body">
                <?php if(is_array($zxwenzhang) || $zxwenzhang instanceof \think\Collection): $i = 0; $__LIST__ = $zxwenzhang;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <h5><a href="<?php echo Url('/index/Index/article/id/'.$vo['id']); ?>" target="_blank"><?php echo $vo['post_title']; ?></a></h5>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <?php endif; if(!(empty($zxpinglun) || ($zxpinglun instanceof \think\Collection && $zxpinglun->isEmpty()))): ?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo lang('Latest comment'); if($permissions < 6): ?>&nbsp;<small>[<a href="<?php echo Url('comments'); ?>"><?php echo lang('All comments'); ?></a>]</small><?php endif; ?></h3>
            </div>
            <div class="panel-body">
                <?php if(is_array($zxpinglun) || $zxpinglun instanceof \think\Collection): $i = 0; $__LIST__ = $zxpinglun;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <h5><a href="<?php echo $vo['url']; ?>" target="_blank"><?php echo $vo['content']; ?></a></h5>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <?php endif; if(!(empty($zxliuyan) || ($zxliuyan instanceof \think\Collection && $zxliuyan->isEmpty()))): ?>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><?php echo lang('Latest message'); ?><?php echo lang('Latest comment'); if($permissions < 6): ?>&nbsp;<small>[<a href="<?php echo Url('messages'); ?>"><?php echo lang('All messages'); ?></a>]</small><?php endif; ?></h3>
            </div>
            <div class="panel-body">
                <?php if(is_array($zxliuyan) || $zxliuyan instanceof \think\Collection): $i = 0; $__LIST__ = $zxliuyan;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <h5><a href="<?php echo Url('messages'); ?>"><?php echo subtext($vo['msg'],100); ?></a></h5>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        <?php endif; ?>
...
<script src="<?php echo $domain; ?>public/common/js/index.js"></script>
