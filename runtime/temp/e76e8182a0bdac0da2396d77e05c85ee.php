...
<div class="row bg-info text-center">
    <h4><?php echo lang('Write an article'); ?></h4>
</div><br>
<div class="container-fluid">
        ...
        <form method="post" action="" name="writeForm">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-lg" placeholder="<?php echo lang('Key words'); ?>" name="guanjianci">
                    <p class="help-block"><?php echo lang('Keywords separated by commas ","'); ?></p>
                </div>
                <div class="form-group">
                    <label><?php echo lang('Article source'); ?>：</label>
                    <input type="text" class="form-control input-lg" placeholder="<?php echo lang('Article source'); ?>" name="laiyuan">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select multiple class="form-control" name="fenlei[]" style="height: 150px;">
                        ...
                        <option value="<?php echo $vo['id']; ?>"><?php echo $vo['level']; if($vo['level'] != ''): ?>└&nbsp;<?php endif; ?><?php echo $vo['term_name']; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
            ...
            <div class="col-md-3">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" id="suolvetu">
                        <img src="<?php echo $domain; ?>public/common/images/default-thumbnail.png" class="img-responsive center-block" alt="<?php echo lang('Thumbnail'); ?>">
                    </div>
                ...
                <?php if($permissions < 6): ?>
                <div class="panel panel-default">
                    <div class="panel-heading"><?php echo lang('Immediate release'); ?></div>
                    <div class="panel-body">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" name="jsfb">
                                <?php echo lang('Immediate release'); ?>
                            </label>
                        </div>
                        <p class="help-block"><?php echo lang('Select the immediate release, the article will immediately show, but will consume more resources, it is recommended not to check'); ?></p>
                    </div>
                </div>
                <?php endif; ?>
            </div>
